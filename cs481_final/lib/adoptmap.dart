...
class AdoptMap extends StatefulWidget {
  @override
  _AdoptMapState createState() => _AdoptMapState();
}

class _AdoptMapState extends State<AdoptMap> {
  ...
  getData() async {
    try {
      final response =
      await http.get('https://maps.googleapis.com/maps/api/place/textsearch/json?query=dog+adoption&location=33.1284381,-117.1578434&radius=10000&key=AIzaSyCea__1_lg7NhgchuV5YERTKpPN0s0x8Ew');
